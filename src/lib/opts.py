...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='mot_rgbt',
    ...
    self.parser.add_argument('--dataset_version', default='mot_rgbt')
    ...
    # test
    self.parser.add_argument('--test_mot_rgbt',type=bool, default=True)
    ...
    self.parser.add_argument('--ltrb_amodal', action='store_true', default=True)
